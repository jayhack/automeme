...
@app.route('/')
def index():
    return render_template('meme_classifier.html')
...
def classsify_meme ():
    ...
    meme_text = {'top':top_text, 'bottom':bottom_text, 'all':(top_text + bottom_text)}

    print "     top_text, bottom_text = " + top_text + ", " + bottom_text + "\n"


    sorted_prob_dist = sa.classify_meme_raw (meme_text)
